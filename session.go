...
type Session interface {
	...
	UserGuilds(int, string, string, bool, ...discordgo.RequestOption) ([]*discordgo.UserGuild, error)
	...
	GuildDelete(guildID string, options ...discordgo.RequestOption) (err error)
	...
	WebhookEdit(string, string, string, string, ...discordgo.RequestOption) (*discordgo.Webhook, error)
	WebhookEditWithToken(string, string, string, string, ...discordgo.RequestOption) (*discordgo.Webhook, error)
	...
	ThreadMember(string, string, bool, ...discordgo.RequestOption) (*discordgo.ThreadMember, error)
	ThreadMembers(string, int, bool, string, ...discordgo.RequestOption) ([]*discordgo.ThreadMember, error)
